...
func runSetup() {
    ...
    print("")
    print("🔧 If no dialog appeared, manually add threefingers:")
    print("")
    print("   ⚙️ Add to Accessibility Settings:")
    print("      1. Go to: System Settings → Privacy & Security → Accessibility")
    print("      2. Click the '+' button")
    print("      3. Press Cmd+Shift+G to open 'Go to Folder'")
    print("      4. Type: /opt/homebrew/bin")
    print("      5. Select 'threefingers' and click 'Add'")
    print("      6. Enable the checkbox next to 'threefingers'")
    print("")
    print("   💡 Pro tip: You can also drag 'threefingers' from Finder directly into the list!")
    print("")
